  ...
  const rows = [
...

    {
      ...
      content: (
        <>
          <p className="m-0">
            Unsere Website wird bei einem externen Hosting-Anbieter betrieben.
            Dabei können personenbezogene Daten wie IP-Adressen oder
            Zugriffsdaten verarbeitet werden.
          </p>
          <p className="m-0">
...

    {
      ...
      content: (
        <>
          ...
          <p className="m-0">Rechtsgrundlage: Art. 6 Abs. 1 lit. f DSGVO.</p>
        </>
      ),
    },
      ...
      content: (
        <>
          <p className="m-0">
            ...
            werden Ihre Angaben zur Bearbeitung Ihrer Anfrage verarbeitet.
          </p>
          <p className="m-0">
      ...
      content: (
        <>
          <p className="m-0">
            ...
            Diese dienen dazu, die Nutzung unserer Website zu analysieren und
            unser Angebot zu verbessern.
          </p>

          <p className="m-0">
            Sofern Analyse- oder Tracking-Tools eingesetzt werden, erfolgt dies
...

    {
      ...
      content: (
        <>
          <p>
            Unsere Website nutzt SSL- bzw. TLS-Verschlüsselung zum Schutz
            übertragener Daten.
          </p>
        </>
      ),
  ...
  return (
    <>
      ...
      <section className="legal-hero">
        ...
        <span className="legal-subtitle">Stand: [13. März 2026]</span>
        <span className="legal-description">
          ...
          der Nutzung unserer Website gemäß der Datenschutz-Grundverordnung
          (DSGVO).
        </span>
      </section>
